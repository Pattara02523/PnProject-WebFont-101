/**
 * ==========================================
 * ลำดับการทำงาน: [ลำดับที่ 50 / Flow ขั้นตอนที่ 50]
 * ชื่อไฟล์: InvestmentContent.tsx
 * หน้าที่หลัก: Component ตารางรายการสินทรัพย์การลงทุนทั้งหมด พร้อมตัวกรองประเภท ค้นหา และ Modal เพิ่มสินทรัพย์
 * รับอะไรมาจากไหน (Input): ข้อมูลจาก `investmentApi.getAll()`
 * ส่งอะไรไปที่ไหนต่อ (Output / Target): Render ตารางสินทรัพย์และการจัดการ
 * ==========================================
 */
