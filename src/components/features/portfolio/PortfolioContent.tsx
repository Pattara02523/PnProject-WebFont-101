/**
 * ==========================================
 * ลำดับการทำงาน: [ลำดับที่ 44 / Flow ขั้นตอนที่ 44]
 * ชื่อไฟล์: PortfolioContent.tsx
 * หน้าที่หลัก: Component แสดงรายการพอร์ตการลงทุนทั้งหมด พร้อม Modal สร้าง/แก้ไข พอร์ตใหม่
 * รับอะไรมาจากไหน (Input): ข้อมูลจาก `portfolioApi.getAll()`
 * ส่งอะไรไปที่ไหนต่อ (Output / Target): Render รายการพอร์ตและฟอร์มสร้างพอร์ต
 * ==========================================
 */
