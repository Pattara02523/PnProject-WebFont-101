/**
 * ==========================================
 * ลำดับการทำงาน: [ลำดับที่ 43 / Flow ขั้นตอนที่ 43]
 * ชื่อไฟล์: PortfolioCard.tsx
 * หน้าที่หลัก: Component การ์ดแสดงผลสรุปพอร์ตการลงทุนแต่ละพอร์ต (ชื่อพอร์ต, มูลค่ารวม, % กำไร/ขาดทุน)
 * รับอะไรมาจากไหน (Input): Portfolio Entity Data Props
 * ส่งอะไรไปที่ไหนต่อ (Output / Target): Render การ์ดพอร์ตการลงทุนพร้อมปุ่มจัดการ
 * ==========================================
 */
