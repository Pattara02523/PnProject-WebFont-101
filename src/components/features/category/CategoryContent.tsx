/**
 * ==========================================
 * ลำดับการทำงาน: [ลำดับที่ 48 / Flow ขั้นตอนที่ 48]
 * ชื่อไฟล์: CategoryContent.tsx
 * หน้าที่หลัก: Component แสดงและจัดการหมวดหมู่สินทรัพย์การลงทุน (สร้าง/แก้ไข/ลบ หมวดหมู่)
 * รับอะไรมาจากไหน (Input): ข้อมูลจาก `categoryApi.getAll()`
 * ส่งอะไรไปที่ไหนต่อ (Output / Target): Render ตารางหมวดหมู่และ Modal จัดการ
 * ==========================================
 */
