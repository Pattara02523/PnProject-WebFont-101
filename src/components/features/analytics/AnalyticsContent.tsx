/**
 * ==========================================
 * ลำดับการทำงาน: [ลำดับที่ 59 / Flow ขั้นตอนที่ 59]
 * ชื่อไฟล์: AnalyticsContent.tsx
 * หน้าที่หลัก: Component แสดงกราฟวิเคราะห์แนวโน้มการลงทุน สัดส่วนความเสี่ยง และ ผลตอบแทนเปรียบเทียบ (Recharts)
 * รับอะไรมาจากไหน (Input): ข้อมูลจาก Dashboard & Analytics API
 * ส่งอะไรไปที่ไหนต่อ (Output / Target): Render กราฟและสถิติการวิเคราะห์
 * ==========================================
 */
