/**
 * ==========================================
 * ลำดับการทำงาน: [ลำดับที่ 82 / Flow ขั้นตอนที่ 82]
 * ชื่อไฟล์: AdminReportsContent.tsx
 * หน้าที่หลัก: Component สรุปรายงานการใช้งานภาพรวมทั้งระบบสำหรับ Admin
 * รับอะไรมาจากไหน (Input): ข้อมูลรายงานสรุประดับระบบ
 * ส่งอะไรไปที่ไหนต่อ (Output / Target): Render หน้ารายงานระบบ Admin
 * ==========================================
 */
