/**
 * ==========================================
 * ลำดับการทำงาน: [ลำดับที่ 21 / Flow ขั้นตอนที่ 21]
 * ชื่อไฟล์: admin.api.ts
 * หน้าที่หลัก: API Client Module สำหรับผู้ดูแลระบบ Admin (ผู้ใช้, ระงับบัญชี, Audit Logs, สถิติระบบ)
 * รับอะไรมาจากไหน (Input): Admin Query Params และ Body DTOs
 * ส่งอะไรไปที่ไหนต่อ (Output / Target): เรียกใช้ `apiFetch` สื่อสารกับ `/admin/*`
 * ==========================================
 */
